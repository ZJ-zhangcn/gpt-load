export default {
  ...
  proxyPool: {
    eyebrow: "送信設定",
    title: "プロキシプール",
    logoLabel: "プロキシプールのロゴ",
    logoWordmark: "POOL",
    description:
      "再利用可能な送信ノードを管理し、キーグループで均等に割り当て、実際のプローブで利用可能性を確認します。",
    overviewTitle: "ノード概要",
    totalNodes: "全ノード",
    bindableNodes: "割り当て可能",
    protocolTypes: "プロトコル種別",
    latestImport: "最新の取り込み",
    currentInventory: "現在の一覧",
    readyToBind: "キーグループで利用可能",
    protocolCount: "種類",
    notImported: "取り込みなし",
    nodesTitle: "ノード一覧",
    nodesHint: "取り込んだノードを管理し、キーグループから均等に割り当てます。",
    allTab: "すべて",
    importedTab: "取り込み済み",
    pendingTab: "確認待ち",
    ...
    ready: "割り当て可能",
    pendingCheck: "確認待ち",
    bindingReady: "均等割り当て対応",
    noBindingYet: "未割り当て",
    importTitle: "クイック取り込み",
    importBadge: "一括取り込み",
    importHint: "1行に1ノード。HTTP / HTTPS / SOCKS5 に対応しています。",
    importFormat: "形式：protocol://[user:password の後に host]:port",
    importPlaceholder: "http://host:port\nsocks5://host:port",
    importSuccess: "{added} 個を取り込み、{ignored} 件を無視しました",
    downloadTemplate: "サンプルをダウンロード",
    clearImport: "クリア",
    importAction: "ノードを取り込む",
    quickImportAction: "クイックインポート",
    nodesCardHint: "状態は実際のプローブ結果です。未確認のノードを利用可能とは表示しません。",
    healthTitle: "確認ステータス",
    healthHint: "各ノード経由で固定プローブへ接続し、結果を保存します。",
    checkAll: "すべて確認",
    checkNode: "ノードを確認",
    checkTarget: "プローブ先：gstatic generate_204",
    checkedNodes: "確認済み",
    healthyNodes: "利用可能",
    unhealthyNodes: "失敗",
    checkPersisted: "結果は保存されます。未確認のノードを利用可能とは表示しません。",
    checkSuccess: "{checked} 個を確認：利用可能 {healthy}、失敗 {unhealthy}",
    checkFailed: "確認リクエストに失敗しました。再試行してください。",
    checkStatus: {
      unchecked: "未確認",
      up: "利用可能",
      down: "失敗",
    },
    empty: "プロキシノードはまだありません",
    emptyHint: "先にノードを取り込み、キー管理から均等に割り当ててください。",
    noFilteredNodes: "条件に一致するノードはありません",
