export default {
  ...
  proxyPool: {
    ...
    title: "プロキシプール",
    description:
      "再利用可能な送信ノードを管理し、キーグループで均等に割り当てます。このページではまずノード一覧を管理し、ヘルスチェックは別途追加します。",
    overviewTitle: "ノード概要",
    totalNodes: "全ノード",
    ...
    healthTitle: "確認ステータス",
    healthLink: "機能について",
    healthUnavailable: "自動ヘルスチェックは未接続です",
    healthHint:
      "取り込み済みノードはキーグループに割り当てられます。チェック接続後にキューと遅延を表示します。",
    healthBoundHint:
      "ノードを削除すると専用プロキシの割り当てもクリアされ、グループまたは環境設定へ戻ります。",
