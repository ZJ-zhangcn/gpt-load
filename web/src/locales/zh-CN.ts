export default {
  ...
  proxyPool: {
    ...
    logoLabel: "代理池标志",
    logoWordmark: "POOL",
    description: "管理可复用的出站节点，在密钥分组中进行均衡绑定，并通过真实探测确认节点可用性。",
    overviewTitle: "节点概览",
    totalNodes: "全部节点",
    bindableNodes: "可用于绑定",
    protocolTypes: "协议类型",
    latestImport: "最近导入",
    currentInventory: "当前清单",
    readyToBind: "可供密钥组使用",
    protocolCount: "种协议",
    notImported: "暂无导入",
    nodesTitle: "节点列表",
    nodesHint: "导入的节点会在这里统一管理，并可在密钥分组中进行均衡分配。",
    allTab: "全部",
    importedTab: "已导入",
    pendingTab: "待检测",
    ...
    importTitle: "快速导入",
    importBadge: "支持批量导入",
    importHint: "每行一个节点，支持 HTTP / HTTPS / SOCKS5 协议。",
    importFormat: "格式：协议://[用户名:密码]主机:端口",
    ...
    nodesCardHint: "状态来自真实探测；未检测节点不会显示为可用。",
    healthTitle: "检测状态",
    healthHint: "通过节点访问固定探针，结果会写回节点。",
    checkAll: "检测全部",
    checkNode: "检测节点",
    checkTarget: "探测目标：gstatic generate_204",
    checkedNodes: "已检测",
    healthyNodes: "可用",
    unhealthyNodes: "失败",
    checkPersisted: "结果已持久化；未检测不会显示为可用。",
    checkSuccess: "已检测 {checked} 个节点：{healthy} 可用，{unhealthy} 失败",
    checkFailed: "检测请求失败，请重试。",
    checkStatus: {
      unchecked: "未检测",
      up: "可用",
      down: "失败",
    ...
    empty: "还没有代理节点",
    emptyHint: "先导入节点，之后即可在密钥管理中进行均衡绑定。",
    noFilteredNodes: "没有符合筛选条件的节点",
