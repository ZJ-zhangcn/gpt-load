export default {
  ...
  proxyPool: {
    eyebrow: "Egress configuration",
    title: "Proxy Pool",
    logoLabel: "Proxy Pool mark",
    logoWordmark: "POOL",
    description:
      "Manage reusable egress nodes, assign them evenly in key groups, and verify availability with a real probe.",
    overviewTitle: "Node overview",
    totalNodes: "All nodes",
    bindableNodes: "Ready to bind",
    protocolTypes: "Protocol types",
    latestImport: "Latest import",
    currentInventory: "Current inventory",
    readyToBind: "Available to key groups",
    protocolCount: "protocols",
    notImported: "No imports yet",
    nodesTitle: "Node list",
    nodesHint: "Manage imported nodes here and assign them evenly from a key group.",
    allTab: "All",
    ...
    bindingReady: "Even assignment ready",
    noBindingYet: "Not assigned",
    importTitle: "Quick import",
    importBadge: "Bulk import",
    importHint: "One node per line. HTTP / HTTPS / SOCKS5 are supported.",
    importFormat: "Format: protocol://[user:password then host]:port",
    ...
    nodesCardHint: "Status comes from a real probe; unchecked nodes are never shown as healthy.",
    healthTitle: "Check status",
    healthHint: "Access a fixed probe target through each node and persist the result.",
    checkAll: "Check all",
    checkNode: "Check node",
    checkTarget: "Probe target: gstatic generate_204",
    checkedNodes: "checked",
    healthyNodes: "healthy",
    unhealthyNodes: "failed",
    checkPersisted: "Results are persisted; unchecked nodes are never shown as healthy.",
    checkSuccess: "Checked {checked} nodes: {healthy} healthy, {unhealthy} failed",
    checkFailed: "The check request failed. Try again.",
    checkStatus: {
      unchecked: "Unchecked",
      up: "Healthy",
      down: "Failed",
    },
    empty: "No proxy nodes yet",
    emptyHint: "Import nodes first, then assign them evenly from key management.",
    noFilteredNodes: "No nodes match the current filters",
    loadFailed: "Could not load proxy nodes. Try again.",
    deleteConfirm:
    ...
    emptyForRebalance: "The proxy pool is empty. Import nodes first.",
