export default {
  ...
  proxyPool: {
    ...
    title: "Proxy Pool",
    description:
      "Manage reusable egress nodes and assign them evenly in key groups. This page maintains the node inventory first; health probing will be added separately.",
    ...
    healthUnavailable: "Automatic health checks are not connected yet",
    healthHint:
      "Imported nodes can be assigned to key groups now. Queue and latency data will appear here when probing is connected.",
    healthBoundHint:
      "Deleting a node clears its dedicated key bindings and falls back to the group or environment proxy.",
